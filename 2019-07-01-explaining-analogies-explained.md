...
[comment]: # ($$\underbrace{\sigma^{\mathcal{W}} -  \sigma^{\mathcal{W_*}} - ( \tau^{\mathcal{W}} -  \tau^{\mathcal{W_*}})\mathbf{1}}_{\text{net dependence error}}$$ ![Paraphrase distributions](/assets/analogy/eqn_paraphrase.png){:height="115px"} {: style="text-align: left; margin-left: 30px"})
