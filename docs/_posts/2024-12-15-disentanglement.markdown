...
<table>
  <tr>
    ...
    <td>        <img src="/assets/disentanglement/diffusion_church.png" 
                alt="frogs" 
                width="160" 
                height="180"/>
    </td>
