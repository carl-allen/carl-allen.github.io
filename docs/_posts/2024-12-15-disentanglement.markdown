...
<p align="center">
        ...
        <img src="/assets/disentanglement/frogs.png" 
                ...
                height="100" 
                style="display: block; margin: 0 auto"  />
        From <a href="[url](https://arxiv.org/pdf/2002.03754)">Voynov \& Babenko (ICML, 2020)</a>: each row of images, which vary by a single semantic factor (hair style, line thickness, orientation), is generated by varying a single dimension of the latent variable or, equivalently, moving in an "axis-aligned" direction in latent space.
</p>
