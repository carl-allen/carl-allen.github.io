...
<img src="https://hackmd.io/_uploads/rkbyishVkg.png" 
        alt="Screenshot 2024-12-15 at 20.01.03" 
        width="420" 
        height="130" 
...
<img src="https://hackmd.io/_uploads/r1vaUi2Nkg.png" 
        alt="Screenshot 2024-12-15 at 19.57.45" 
        style="display: block; margin: 0 auto" />
...
$$\text{diag. posterior covariance} 
    ...
    \text{column-orthog. Jacobian} 
    \ \ \overset{B}{\Rightarrow}\ \   
    \text{disentanglement}$$


---
**Notation**: $\quad$ data $x\in\!\mathcal{X} \subseteq\mathbb{R}^n$, $\quad$ latent variables $z\in\!\mathcal{Z} =\mathbb{R}^m$.
...
<img src="https://hackmd.io/_uploads/rk4_Ai3VJg.png" 
        alt="linear2" 
        width="440" 
        height="190" 
        style="display: block; margin: 0 auto" />
...
$$\qquad\qquad p_\theta(z|x) = \mathcal{N}(z;\, \tfrac{1}{\sigma^2}M D^\top\! x,\, M) \quad\quad\quad M = (I \!+\! \tfrac{1}{\sigma^2}D^\top\!D)^{-1}\qquad\qquad 
    (2)$$

This can be seen as a special case of Eq 1, thus the ELBO is maximised if $\Sigma_x\!=\!M,\ \forall x\!\in\!\mathcal{X}$, and using diagonal posteriors $\Sigma_x$ again implies $V\!=\!I$ (for SVD $D\!=\!USV^\top$). 
...
<img src="https://hackmd.io/_uploads/r1tcCihEJe.png" 
        alt="non_linear2" 
        width="420" 
        height="200" 
        style="display: block; margin: 0 auto" />
