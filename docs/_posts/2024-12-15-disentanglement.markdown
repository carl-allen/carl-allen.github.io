...
<p align="center">
    <small>Figure 1. Illustrating disentangelement: <emph>(left)</emph> Each row of images varies by a single semantic feature: hair style, line thickness, orientation. A feature is considered disentangled if such images can be generated by varying a single latent dimension, i.e. distinct latent variables control distinct features. From a geometric perspective, this equates to moving  in an "axis-aligned" direction, or parallel to a standard basis vector, in latent space. <emph>(right)</emph> Using disentangelement to change the style of an image in diffusion models.</small>
</p>
<p align="center">
  <small>(Images from <a href="[url](https://arxiv.org/pdf/2002.03754)">Voynov & Babenko (2020))</a> and <a href="[url](https://openaccess.thecvf.com/content/CVPR2023/papers/Wu_Uncovering_the_Disentanglement_Capability_in_Text-to-Image_Diffusion_Models_CVPR_2023_paper.pdf)">Wu et al. (2023))</a></small>
</p>
