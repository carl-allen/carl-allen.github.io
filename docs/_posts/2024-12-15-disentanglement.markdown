...
<p align="center">
        ...
        <img src="/assets/disentanglement/frogs.png" 
                ...
                height="60" 
                style="display: block; margin: 0 auto"  />
    <small>Illustrating disentangelement: each row of images varies by a single semantic feature: hair style, line thickness, orientation. A feature is considered _disentangled_ if such images are generated by varying a single dimension of the latent variable, i.e. a distinct latent variable controls a distinct feature. From a geometric perspective, this equates to moving  in an "axis-aligned" direction, or parallel to a standard basis vector, in latent space. (Images from <a href="[url](https://arxiv.org/pdf/2002.03754)">Voynov & Babenko (2020))</a></small>
</p>
